...
public class DemoSpelAction {
	...
	public static void main(String[] args) {
		...
		Expression express3 = parser.parseExpression("3.14*10*10");
		double result3 = express3.getValue(Double.class);
		System.out.println("result3:" + result3);

		StandardEvaluationContext ectx = new StandardEvaluationContext();
		
		Fish fish1 = new Fish(10001,"SwordFish","Large");
		Fish fish2 = new Fish(10002,"GoldFish","Small");
