...
public class ResourcesController {
	...
	public byte[] processClassPathResourceAction() throws IOException {
		Resource resource = new ClassPathResource("static/images/image01.jpg");
	...
	@GetMapping(path = "/resourcesloader.controller" , produces = MediaType.IMAGE_JPEG_VALUE) //application/json
	public byte[] processResourceLoaderAction() throws IOException {
//		Resource resource = resourceLoader.getResource("classpath:static/images/image01.jpg");
		Resource resource = resourceLoader.getResource("/WEB-INF/resources/images/image03.jpg");
...
//	@Value("classpath:static/images/image01.jpg")
	@Value("/WEB-INF/resources/images/image03.jpg")
